                ...
                
{
              ...
              /root/bin/az storage blob upload-batch --destination ${params.containerName} --source index.js --account-name $AZURE_STORAGE_ACCOUNT --service-principal -u $AZURE_CLIENT_ID -p $AZURE_CLIENT_SECRET -t $AZURE_TENANT_ID
              # Logout from Azure
              /root/bin/az logout                  """
                         }
            }
